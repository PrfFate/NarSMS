...
class _ApprovedSalesPageState extends State<ApprovedSalesPage> {
                ...
                CustomActionMenuWidget(
                  items: [
                    CustomActionMenuItem(
                      ...
                      onTap: () async {
                        await Navigator.pushNamed(context, AppRouter.carrierManagement);
    ...
    return Card(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return _SaleApprovedCard(sale: sales[index], onRefresh: _load);
        },
      ),
    );
  }
  ...
  Widget _buildEmpty() => Card(
    ...
    child: const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      SizedBox(height: 16),
      Text('Onaylanan satış bulunamadı', style: TextStyle(fontSize: 14, color: Colors.grey)),
    ])),
  );
