...
class _CompletedSalesPageState extends State<CompletedSalesPage> {
    ...
    return Card(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return _SaleCompletedCard(sale: sales[index], onRefresh: _load);
        },
      ),
    );
  }
  ...
  Widget _buildEmpty() => Card(
    ...
    child: const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Icon(Icons.verified_rounded, size: 64, color: AppColors.primary),
      SizedBox(height: 16),
      Text('Tamamlanan satış bulunamadı', style: TextStyle(fontSize: 14, color: Colors.grey)),
    ])),
  );
...
class _SaleCompletedCard extends StatelessWidget {
  final SaleEntity sale;
  final VoidCallback onRefresh;
  const _SaleCompletedCard({required this.sale, required this.onRefresh});
