...
/// Teslim edilen satışlar sayfası.
...
class _DeliveredSalesPageState extends State<DeliveredSalesPage> {
  ...
  static const String _status = 'Delivered';
    ...
    return Card(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return _SaleDeliveredCard(sale: sales[index], onRefresh: _load);
        },
      ),
    );
  }
  ...
  Widget _buildEmpty() => Card(
    ...
    child: const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      SizedBox(height: 16),
      Text('Teslim edilen satış bulunamadı', style: TextStyle(fontSize: 14, color: Colors.grey)),
    ])),
  );
...
class _SaleDeliveredCard extends StatelessWidget {
  final SaleEntity sale;
  final VoidCallback onRefresh;
  const _SaleDeliveredCard({required this.sale, required this.onRefresh});
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.done_all, color: AppColors.primary, size: 24),
            ),
