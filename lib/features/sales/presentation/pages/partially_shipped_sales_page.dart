...
///
/// [GET /api/sale/search?status=PartiallyShipped&page=n&pageSize=20]
  ...
  Widget _buildList(List<SaleEntity> sales) {
    return Card(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) => _SalePartiallyShippedCard(
          sale: sales[index],
          onRefresh: _load,
        ),
      ),
      ...
      child: const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Kısmi kargolanan satış bulunamadı',
...
class _SalePartiallyShippedCard extends StatelessWidget {
  ...
  const _SalePartiallyShippedCard(
      {required this.sale, required this.onRefresh});
