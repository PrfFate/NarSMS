...
class _PendingSalesPageState extends State<PendingSalesPage> {
                ...
                CustomActionMenuWidget(
                  items: [
                    CustomActionMenuItem(
                      ...
                      onTap: () async {
                        final result = await Navigator.pushNamed(context, AppRouter.saleAdd);
                        if (result == true && context.mounted) _load();
                      },
                    ),
                  ],
                ),
  ...
  Widget _buildEmpty() => Card(
    ...
    child: const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      SizedBox(height: 16),
      Text('Bekleyen satış bulunamadı', style: TextStyle(fontSize: 14, color: Colors.grey)),
    ])),
  );
  ...
  Widget _buildError(String message) => Card(
    ...
    child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      const SizedBox(height: 16),
      ElevatedButton(onPressed: _load, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFF57C00), foregroundColor: Colors.white), child: const Text('Tekrar Dene')),
    ])),
  );
}
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.hourglass_top_rounded, color: AppColors.primary, size: 24),
            ),
