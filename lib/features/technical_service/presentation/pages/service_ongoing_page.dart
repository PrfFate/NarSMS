...
/// Devam Eden İşlemler listesi.
/// GET /api/ServiceRequest/paged?status=InProgress
    ...
    return Card(
      ...
      child: const Center(
        child: Column(
          ...
          children: [
            Icon(Icons.pending_actions, size: 64, color: Color(0xFFF57C00)),
            SizedBox(height: 16),
            Text(
              'Devam eden işlem bulunmuyor',
          ...
          return InkWell(
            onTap: () async {
              final result = await Navigator.pushNamed(
                context,
                AppRouter.serviceOngoingDetail,
                arguments: request,
              );
